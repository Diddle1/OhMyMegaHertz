...
#define IR_LED_PIN 1       // Replace with your actual IR LED pin
#define IR_RECEIVE_PIN 2   // Replace with your actual IR receiver pin
lv_obj_t *irTab;
lv_obj_t *listenButton;
...
static void lv_touchpad_read(lv_indev_drv_t *indev_driver, lv_indev_data_t *data)
{
    ...
    void setup()
    {
        ...
        delay(100);
        SPI2.begin(CC1101_SCK, CC1101_MISO, CC1101_MOSI, CC1101_CS);
        ELECHOUSE_cc1101.setSpiPin(CC1101_SCK, CC1101_MISO, CC1101_MOSI, CC1101_CS);     
        ELECHOUSE_cc1101.setMHZ(freq_1);
        currentFrequency = freq_1;
        ELECHOUSE_cc1101.setPA(12); // Set initial power to lowest (1)
        ...
        mySwitch.enableTransmit(gdo0);  // Set the pin for transmission
    ...
    void loop()
    {
        ...
        if (showPopupFlag) {
            showPopup("Signal received!");  // Show the popup
            showPopupFlag = false;  // Reset the flag
        }               
        delay(2);
    }